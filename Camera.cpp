...
void Camera::Matrix(float FOVdeg, float nearPlane, float farPlane, Shader& shader, const char* unifrom)
{
	...
	glUniformMatrix4fv(glGetUniformLocation(shader.ID, unifrom), 1, GL_FALSE, glm::value_ptr(proj * view));
}
